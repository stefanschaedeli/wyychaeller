...
- Lagerorte halten fest, wo die Flaschen genau liegen: ein einfacher, benannter Ort oder ein Raster mit Reihen und Plätzen. Gleich nach dem Etikett-Foto fragt ein Overlay, wo die Flaschen liegen: Lagerort aus der Liste wählen, pro Flasche den Platz antippen und mit dem grünen Haken bestätigen; danach kann das nächste Etikett fotografiert werden. «Mehr → Lagerorte» zeigt jeden Ort mit seinen Weinen und der Belegung.
